...
int main(int argc, char *argv[])
{
    ...
    for (i = 0; i < 500; ++i) {
        dimanet_train(ann, input[0], output + 0, 3);
        dimanet_train(ann, input[1], output + 1, 3);
        dimanet_train(ann, input[2], output + 2, 3);
        dimanet_train(ann, input[3], output + 3, 3);
    }
